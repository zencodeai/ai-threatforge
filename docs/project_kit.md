...
│       ├── mapping_config.toml         # Expansion config + suggestions config
│       ├── mapping_suggestions.toml    # Auto-generated suggestions (by sync --map-heuristics)
...
│                                       #   score-risks, ui, sync, suggest-mappings
